...
describe('utilitues/bytesToString.js', function() {
  describe('bytesToString', function() {
    ...
    it('should return the argument if it is not a real number', function () {
      expect(bytesToString(Infinity)).to.equal(Infinity)
    })
  })
})
