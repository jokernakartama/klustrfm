 ...
 * @param instance {AX} AX instance
 * @param url {string} URL without any query parameters
 * @param method {string}
...
// methods
/**
 * AX[method] spefies request method and set query url
 * @param url {String} Url without any parameters
 * @param params {Object} Serializable object of url parameters, e. g. /api turns to /api?key=value
 */
...
// callbacks
/**
 * Defines response statuses which initiate callback
 * @example
 ...
 * @param state {String} Callback name
 * @param fn {Function} Function(responseBody, responseData)
 * @returns {AX}
 */
...
/**
  ...
  * This method has some shortcuts and in most cases it is used by itself when appears to send no data.
